        ...
        <>
          <div className="deals-grid">
            {cartProducts.map(item => (
              <div key={`${item.id}-${item.size}`} className="deal-card">
                ...
                <p className="price"><span className="new">{item.newPrice} грн</span></p>

                <p className="description">Розмір: <strong>{item.size}</strong></p>
                ...
                <div className="card-footer">
                  ...
                  <button className="basket-remove" onClick={() => removeFromCart(item.id, item.size)}>
                    Видалити
                  </button>
                </div>
              </div>
          ...
          <div className="basket-bottom">
            ...
            <div className="basket-buttons">
              <NavLink to="/order" className="basket-buy-btn">Оформити замовлення</NavLink>
              <button onClick={clearCart} className="basket-clear-btn">Видалити все</button>
            </div>
          </div>
        </>
      )}
